package state.utilitystates.roundstates
{
	...
	/**
	 *
	 *	This class represents round two of the single player mode and is a substate
	 * 	of Game State. 
	 * 
	 ...
	 *
	 */
	public class RoundTwo implements roundState
	{
		//--------------------------------------------------------------------------
		//
		// Private properties
		 ...
		 * 
		 */
		public function RoundTwo($state:GameState)
		{
			_THIS = $state;
		}
		...
		public function onEnter():void
		{
			...
			_THIS.uiBar.playerOne.dynamiteCount	= 6;
			_THIS.uiBar.playerOne.roundLength 	= Register.roundTwoTime;
			_THIS.uiBar.playerOne.treasureTotal   = 6;
			_THIS.tileMap.randomizeChestsRTwo();
		...
		{
			Session.application.state = new RoundEnd($timeRemaining, 2, _THIS.uiBar.background, _THIS);
		}
	}
}